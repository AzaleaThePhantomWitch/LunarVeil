...
namespace LunarVeil.Systems.Skies
{
    public class CloudySky : CustomSky
    {
        ...
        private void DrawGradient(SpriteBatch spriteBatch)
        {
            ...
            var cloudTexture = ModContent.Request<Texture2D>("LunarVeil/Assets/NoiseTextures/ColorMap");
            MiscShaderData eff = LunarVeilUtils.GradientShader;
        ...
        private void DrawBackClouds(SpriteBatch spriteBatch)
        {
            ...
            var texture = ModContent.Request<Texture2D>("LunarVeil/Assets/NoiseTextures/Clouds3");
            var cloudTexture = ModContent.Request<Texture2D>("LunarVeil/Assets/NoiseTextures/ColorMap");
            MiscShaderData eff = LunarVeilUtils.CloudsShader;
            if (!Main.dayTime)
                eff = LunarVeilUtils.NightCloudsShader;
        ...
        {
            var texture = ModContent.Request<Texture2D>("LunarVeil/Assets/NoiseTextures/Clouds2");
            var cloudTexture = ModContent.Request<Texture2D>("LunarVeil/Assets/NoiseTextures/ColorMap");
            MiscShaderData eff = LunarVeilUtils.CloudsShader;
            if (!Main.dayTime)
                eff = LunarVeilUtils.NightCloudsShader;
        ...
        private void DrawFrontClouds(SpriteBatch spriteBatch)
        {
            var texture = ModContent.Request<Texture2D>("LunarVeil/Assets/NoiseTextures/Clouds3");
            var cloudTexture = ModContent.Request<Texture2D>("LunarVeil/Assets/NoiseTextures/ColorMap");
            MiscShaderData eff = LunarVeilUtils.CloudsFrontShader;
