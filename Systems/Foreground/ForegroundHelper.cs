...
namespace LunarVeil.Systems.Foreground;
...
public class ForegroundHelper : ModSystem
{
    ...
    public static Texture2D GetTexture(string name) => LunarVeil.Instance.Assets.Request<Texture2D>("Assets/Gores/Foreground/" + name).Value;
    ...
    internal static void Save(TagCompound compound)
    {
        ...
        compound.Add("LunarVeil:Foreground", compounds);
        compound.Add("LunarVeil:PlayerLayerForeground", playerLayerCompounds);
    }

    internal static void Load(TagCompound compound)
    {
        if (compound.ContainsKey("LunarVeil:Foreground"))
        {
            if (compound["LunarVeil:Foreground"] is not TagCompound tag)
                return;
        ...
        if (compound.ContainsKey("LunarVeil:PlayerLayerForeground"))
        {
            if (compound["LunarVeil:PlayerLayerForeground"] is not TagCompound playerLayerTag)
                return;
