    ...
    public override bool? CanDamage() => false;
        ...
        private void ShootArrow()
        {
            ...
            if (IsPowerShot())
            {
                ...
                Main.projectile[arrow].GetGlobalProjectile<LunarVeilGlobalProjectile>().IsPowerShot = true;

                // if you want to add another projectile
                /*
        ...
        private void DrawArrow(Color lightColor)
        {
            ...
            Effect effect = LunarVeil.Instance.Whiteout.Value;
